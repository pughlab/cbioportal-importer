...
class PortalInstance(object):
    ...
    def load_genome_info_from_arg(self, args):
        self.species, self.ncbi_build, self.genome_build = args.species, args.ncbi_build, args.genome_build
...
class MutationsExtendedValidator(Validator):
    ...
    def check_t_ref_count(self, value):
        if not self.checkInt(value) and value != '' and value != '.':
            return False
        return True
